 ...
 * <p>
 * The objective is only to support the construction of remote restart and reset of a TEST
 * ABIS installation to support automated regression tests that need to return to a prior state
 * @author Gavan
 *
 */
