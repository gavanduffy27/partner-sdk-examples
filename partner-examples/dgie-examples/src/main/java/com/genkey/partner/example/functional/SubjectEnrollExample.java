 ...
 *
 */
public class SubjectEnrollExample extends PartnerExample {
...
//				forceTestDomain(subject);
	...
	private void handleVerificationFailure(SubjectEnrollmentReference enrollmentRef, VerifyResponse verifyResponse) {
		MatchResult matchResult = verifyResponse.getMatchResult();
		double score = matchResult.getMatchScore();
		// etc
	}

	private void handleMatchResults(BiographicProfileRecord biographicRecord, MatchEngineResponse response) {
	...
	private void examineMatchResult(String subjectManifest, String matchManifest, ImageBlob subjectPortrait,
			ImageBlob matchPortrait) {
		// TODO Auto-generated method stub

	}

	private static void handleRESTFailure(SubjectEnrollmentReference subject, ABISResponse response,
			RemoteAccessService service) {
		handleRESTFailure(subject, service);
	}

	private static void handleRESTFailure(SubjectEnrollmentReference subject, RemoteAccessService service) {
