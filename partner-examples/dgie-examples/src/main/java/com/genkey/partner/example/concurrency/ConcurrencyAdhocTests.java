...
public class ConcurrencyAdhocTests extends ConcurrencyTest {
  ...
  /**
   * Test was put in place to debug structural issues on the cached Subject references which are
   * exploited to enable very high stress loads on ABIS from a single client.
   */
  @Test
