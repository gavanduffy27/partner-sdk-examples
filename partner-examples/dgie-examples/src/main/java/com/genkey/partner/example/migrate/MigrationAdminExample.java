    ...
    if (migrationService == null) {
      RestServices.getInstance()
          .registerServiceClass(
              LegacyMigrationService.class,
              PartnerExample.getPrimaryHost(),
              PartnerExample.getServicePort());

      migrationService =
          RestServices.getInstance().accessServiceInstance(LegacyMigrationService.class);
    }
