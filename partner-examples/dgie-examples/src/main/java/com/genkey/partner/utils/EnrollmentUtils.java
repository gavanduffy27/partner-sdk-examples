...
public class EnrollmentUtils {
  ...
  public static void enrollSubject(
      SubjectEnrollmentReference result, int subjectId, int startSample, int maxSamples) {
    ...
    while (!result.isComplete() && nSamples < maxSamples) {
      ...
      List<ImageData> images2 = TestDataManager.loadImages(subjectId, fingers, sampleIndex);
      addCaptureData(result, fingers, images2);
      sampleIndex++;
      nSamples++;
    }
  }
  ...
  public static BiographicProfileRecord getSimpleBiographicRecord(
      String biographicId, String firstName, String lastName, String gender) {
  ...
  public static void populateTestRecord(
      BiographicProfileRecord record, String firstName, String lastName) {
    record.setFirstName(firstName);
    record.setLastName(lastName);
