...
public class EnrollmentUtils {
	...
	public static SubjectEnrollmentReference enrollSubject(int subjectId, int [] fingers, int startSample, int maxSamples) {
	...
	private static void addCaptureData(SubjectEnrollmentReference enrollmentReference, int [] fingers, List<ImageData> images) {
	...
	public static BiographicProfileRecord getSimpleBiographicRecord(String biographicId, String firstName, String lastName, String gender) {
	...
	public static SubjectEnrollmentReference accessEnrollmentRecord(long subjectId, int sampleIndex, String domain, int shift) {
