...
/**
 * Utilities for expedient generation of test data for code examples. This is
 * based on accessing image test files that are typically provided within the
 * GENKEY_HOME configuration area.
 *
 * <p>
 * Note there are routines for easy loading of biometric ReferenceDataItems from
 * test images which are not intended to be indicative of how this would be
 * achieved in a live capture context.
 *
 * @author gavan
 */
public class TestDataManager {
	...
	public static Map<Integer, ImageData> loadImagesIfPresent(int subject, int[] fingers, int sample) {
	...
	public static List<ReferenceDataItem> loadReferences(List<String> imageFiles, int[] fingers, int version,
	...
	public static void cacheAnonymousReference(long subject, boolean useLegacy,
			AnonymousFusionReference fusionReference) {
		String fileName = getSubjectKeyFile(subject, useLegacy);
		try {
	...
	public static AnonymousFusionReference createAnonymousReference(long subject, boolean useLegacy, int[] fingers,
			int sampleIndex) {
