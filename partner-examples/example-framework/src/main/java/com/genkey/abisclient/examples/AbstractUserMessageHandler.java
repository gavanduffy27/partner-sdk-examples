...
/**
 * Functionally complete implementation of UserMessageHandler with specializing class reqquiring
 * only to implement a minimal set of methods for display of text and image.
 *
 * @author Gavan
 */
