...
public class ExampleSettings {
  ...
  // Note the following property values are arbitrary, and any application can use any convention it
  // wants
  ...
  public void initialize() {
    ...
    try {
      // String iniFile = SystemSettings.getPropertyValue(InternalSettings.ENV_INI_FILE,
      // defaultValue)
