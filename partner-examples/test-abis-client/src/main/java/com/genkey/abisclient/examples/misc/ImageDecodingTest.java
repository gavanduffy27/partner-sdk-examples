...
public class ImageDecodingTest extends ExampleModule {
  ...
  public static void convertImages(
      String sourceDir, String sourceFormat, String targetDir, String targetFormat) {
    try {
  ...
  public void testImageEncoding(ImageData imageData, String fileName, String format) {
    try {
      // Encode image
