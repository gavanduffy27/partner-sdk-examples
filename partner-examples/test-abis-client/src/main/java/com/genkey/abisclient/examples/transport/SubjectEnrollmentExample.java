...
public class SubjectEnrollmentExample extends TransportExampleModule {
    ...
    public void doXmlExample() {
    	SubjectEnrollmentReference subjectReference = super.generateSubjectBlob(1, FourFingers, SingleSample, false, true);
	...
	public void doMultiSampleExample() {
	   	SubjectEnrollmentReference subjectReference = super.generateSubjectBlob(1, FourFingers, TwoSamples, false, true);
    ...
    public void transportTest(SubjectEnrollmentReference xmitRef)
    {
        ...
        for(int finger : fingers) {
        	...
        	for(int sampleIndex=0; sampleIndex < sampleCount ; sampleIndex++) {
        		...
        		FingerEnrollmentReference fingerRef = recvRef.getReferenceForFingerSample(finger, sampleIndex);
	            ...
	            if (hasReference)
	            {
	                ...
	                for(String algorithm : algorithms)
	                {
	                	...
	                	// Obtain the ABIS3 algorithm encoding which for recent versions is the same as raw encoding
