...
public class FingerDecodingExample extends TransportExampleModule  {
	...
	public void testSemlexEncoding() {
		...
		try {
			byte [] semlexEncoding = SemlexEncodeUtils.encodeSemlexFormat(fingerId, referenceData, imageEncoding, "wsq");
	...
	private void checkBlobsEqual(FingerEnrollmentReference fingerBlob, FingerEnrollmentReference fingerBlob2) {
	...
	public byte[] javaEncodeFingerReference(ReferenceDataItem dataItem, byte [] imageEncoding, String format) {
