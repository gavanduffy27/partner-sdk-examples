...
public class AuthenticationExample extends TransportExampleModule {
    ...
    {
        // Calls the helper routine that Creates the PK for given combination of subject, finger and sample index
        ...
        for (int sampleIndex = 1; sampleIndex <= 2; sampleIndex++)
        {
            ...
            FingerEnrollmentReference genuine = generateFingerBlob(subject1, finger, sampleIndex, false, true);
            FingerEnrollmentReference impostor = generateFingerBlob(subject2, finger, sampleIndex, false, true);
    ...
    void testMatchReferences(FingerEnrollmentReference enrolment, FingerEnrollmentReference test, Boolean expected)
    {
        ...
        // The real score is formed as -10 * Log10(Far) and is much more useful than the dumb probability score
